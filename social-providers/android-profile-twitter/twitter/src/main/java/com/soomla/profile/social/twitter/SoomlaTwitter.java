...
public class SoomlaTwitter implements IAuthProvider, ISocialProvider {
    ...
    private static String TWITTER_OAUTH_SECRET = "oauth.secret";
    private static String TWITTER_SCREEN_NAME = "oauth.screenName";
...
//     (need to be accessed by static context)
    ...
    public void login(final Activity parentActivity, final AuthCallbacks.LoginListener loginListener) {
        ...
        TwitterAuthConfig config = new TwitterAuthConfig(TWITTER_SCREEN_NAME, TWITTER_OAUTH_SECRET);
        Fabric.with(parentActivity, new Twitter(config));
        loginProcess = true;
    ...
    public void configure(Map<String, String> providerParams) {
        autoLogin = false;
        TWITTER_SCREEN_NAME = providerParams.get("consumerKey");
        TWITTER_OAUTH_SECRET = providerParams.get("consumerSecret");
        ...
        SoomlaUtils.LogDebug(TAG, String.format(
                ...
                TWITTER_SCREEN_NAME, TWITTER_OAUTH_SECRET));

        if (TextUtils.isEmpty(TWITTER_SCREEN_NAME) || TextUtils.isEmpty(TWITTER_OAUTH_SECRET)) {
