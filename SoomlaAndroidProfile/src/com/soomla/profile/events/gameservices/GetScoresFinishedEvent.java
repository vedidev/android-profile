...
public class GetScoresFinishedEvent extends BaseGameServicesEvent {
    public final Leaderboard Leaderboard;
    public final List<Score> Scores;
    public final boolean HasMore;

    public GetScoresFinishedEvent(IProvider.Provider provider, Leaderboard leaderboard, List<Score> scores, boolean hasMore, String payload) {
